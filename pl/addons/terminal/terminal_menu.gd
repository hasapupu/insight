...
func _ready():
	...
	Terminal.add_to_log("""                                                                                                       
	FGGG        GGGGGGGGGF FGGG    GGGG  FGGGGGG     GGGGGGGGGF    FGGGGGGGGFFGGF   FGGF  FGGGGGGGGF   
	  GGG          GGGF    FGGGGF  GGGG FGGF  GGGF      GGGF      GGGF      FFGGF   FGGF     GGGF      
	   FGFG        GGGF    FGGGGGF GGGG GGGF            GGGF    FGGG        FFGGF   FGGF     GGGF      
	   FFGFF       GGGF    FGGFFFGGGGGG  FFFFFFGGFF     GGGF    FGGG  FFGGGGFFGGFFFFFGGF     GGGF      
	  FFGFF        GGGF    FGGG FFGGGGG FGGF   FGGG     GGGF    FFGGGF  GGGGFFGGF   FGGF     GGGF      
	FGGG        GGGGGGGGGF FGGG    GGGG  FGGGGGGGF   GGGGGGGGGF    FGGGGGGGGFFGGF   FGGF     GGGF      
							   ...
							   FFGG                FGGG              FGGFF                             
								GGGG               FGGG              FGGG                              
								 FGGF              GGGF             GGGF                               
								 FGGGF               F             GGGGF                               
								   GGF   FFFFFFFFFGGGGGFFGFFFFFF   FGG                                 
									FFFFF     FFF        FFF     FFFFF                                 
								 GF          FF    FFFFF    F          FFF                             
							  FF            F   FGGGGGGGGF   GF           FF                           
							 GF            FF  FGGGGGGGGGGF   F            FF                          
							 FF            FF  GGGGGGGGGGGF   F            FF                          
							  FF           FF   FGGGGGGGGG   FG           FF                           
							   FGF          FF   FGGGGFFF   FF          FFF                            
								  FGFFF       FF          FFF      FFFFF                               
										FGFGFFF FGGGFFFGGF FFFFGFF                                     
